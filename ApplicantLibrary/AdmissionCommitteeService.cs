...
namespace AdmissionCommitteeBackend
{
    ...
    {
        private const string ConnectionString = "C:\\Users\\Дмитрий\\Documents\\GitHub\\ApplicantProject\\ApplicantLibrary\\Базы данных\\ApplicantDB.sqbpro"; //Тут должен быть путь до базы данных с абитурентами
